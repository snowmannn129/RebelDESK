...
foreach ($issue in $keyIssues) {
    ...
    try {
        gh issue create --title $issue.title --body $issue.body --label $issue.labels --project "https://github.com/users/snowmannn129/projects/1"
        $successCount++
...
Write-Output "You can now check your GitHub project board to see the issues."
