...
Write-Host "Executing GitHub issue creation commands..."

# Create issues for pending tasks
Write-Host "Creating issues for pending tasks..."

gh issue create --title "[Overall] Compiler integration" --body "Task from C:\Users\snowm\Desktop\VSCode\RebelDESK\progress.md
Section: Overall Progress: 42% Complete" --label "overall,task,normal-priority,enhancement"
...
Section: Status: 28% Complete" --label "ai,task,normal-priority,feature"
...
Write-Host "Created first batch of issues (11 issues)..."
...
Section: Status: 28% Complete" --label "ai,task,normal-priority,enhancement"
...
Write-Host "Created second batch of issues (10 issues)..."
...
Section: Status: 15% Complete" --label "backend,task,normal-priority,feature"
...
Write-Host "Created third batch of issues (10 issues)..."
...
Section: Status: 50% Complete" --label "file_manager,task,normal-priority,feature"
...
Write-Host "Created fourth batch of issues (10 issues)..."
...
Section: Status: 50% Complete" --label "file_manager,task,normal-priority,enhancement"
...
Section: Status: 25% Complete" --label "tests,task,normal-priority,feature"
...
Write-Host "Created fifth batch of issues (10 issues)..."
...
Write-Host "Created sixth batch of issues (10 issues)..."
...
Section: Status: 40% Complete" --label "ui,task,normal-priority,feature"
...
Section: Status: 50% Complete" --label "editor,task,normal-priority,feature"

Write-Host "Created seventh batch of issues (10 issues)..."
...
Section: Status: 50% Complete" --label "editor,task,normal-priority,enhancement"
...
Section: Status: 40% Complete" --label "settings,task,normal-priority,feature"
...
Write-Host "Created eighth batch of issues (10 issues)..."
...
Write-Host "Created final batch of issues (1 issues)..."

Write-Host "GitHub issue creation completed! Created 82 issues in total."
